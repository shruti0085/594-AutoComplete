...
public class AutocompleteTest {
    ...
    public void test1of3_Autocomplete_IllegalStateException()
    {
		...
		Autocomplete a = new Autocomplete(h1, h2);    
     ...
     */
    @Test(expected = IllegalStateException.class) 
    public void test2of3_Autocomplete_IllegalStateException()
    {
		...
		Autocomplete a = new Autocomplete(h1, successors);    
